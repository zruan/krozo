          ...
          <div className="row align-items-center full-screen">
            <div className="col-lg-12">
              <div className="hb-typo text-center">
                <h6>Hi There, I'm</h6>
                <h1 className="font-alt">Zheng Ruan</h1>
                <h2>
                  <TextLoop>
                    <span className="loop-text">Structural Biologist</span>
                    <span className="loop-text"> Bioinformatics</span>
                    <span className="loop-text"> Postdoctoral Fellow at Van Andel Institute</span>
                  </TextLoop>{" "}
                </h2>
              </div>
            </div>
